...
const URL_CREATE_ELEMENT     = "api_bill_societies_create";
const URL_UPDATE_GROUP       = "api_bill_societies_update";
...
export function SocietyFormulaire ({ type, typeForm="society", onChangeContext, onUpdateList, element })
{
    ...
    let form = <Form
        ...
        forme={element ? Formulaire.setValueEmptyIfNull(element.forme, 1) : 1}
        ...
        footerInvoice={element ? Formulaire.setValueEmptyIfNull(element.footerInvoice) : ""}
        noteInvoice={element ? Formulaire.setValueEmptyIfNull(element.noteInvoice) : ""}
        footerQuotation={element ? Formulaire.setValueEmptyIfNull(element.footerQuotation) : ""}
        noteQuotation={element ? Formulaire.setValueEmptyIfNull(element.noteQuotation) : ""}
        footerAvoir={element ? Formulaire.setValueEmptyIfNull(element.footerAvoir) : ""}
        noteAvoir={element ? Formulaire.setValueEmptyIfNull(element.noteAvoir) : ""}
...
export class Form extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            footerInvoice: props.footerInvoice,
            noteInvoice: props.noteInvoice,
            footerQuotation: props.footerQuotation,
            noteQuotation: props.noteQuotation,
            footerAvoir: props.footerAvoir,
            noteAvoir: props.noteAvoir,
            errors: [],
            success: false,
            arrayPostalCode: [],
            arrayBic: [],
    ...
    handleSubmit = (e) => {
        ...
        const { name, address, zipcode, city, country } = this.state;
        ...
        if(address === "A définir"){
            validate.code = false;
            validate.errors.push({
                name: "address",
                message: "Veuillez saisir une adresse postale valide."
            })
    ...
    render () {
        ...
        const { errors, success, name, logo, siren, siret, rcs, numeroTva, forme, email, phone1,
            address, address2, zipcode, city, complement, country,
            bankName, bankNumero, bankTitulaire, bankBic, bankCode, bankIban,
            footerInvoice, noteInvoice, footerQuotation, noteQuotation, footerAvoir, noteAvoir } = this.state;
        ...
        return <>
            <form onSubmit={this.handleSubmit}>
                ...
                {typeForm === "society" ? <>
                            ...
                            <div className="form-group">
                                <div className="line">
                                    <Drop ref={this.inputLogo} identifiant="logo" previewFile={logo} errors={errors} accept={"image/*"} maxFiles={1}
                                          label="Téléverser un logo" labelError="Seules les images sont acceptées.">Logo utilisé sur les documents</Drop>
                                </div>

                                <ButtonSubmit context="create" />
                            </div>
                            <div className="form-group" />
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="line line-2">
                            <div className="form-group">
                                ...
                                <div className="line">
                                    <Radiobox items={formItems} identifiant="forme" valeur={forme} errors={errors} onChange={this.handleChange}>
                                        Forme juridique
                                    </Radiobox>
                                </div>
                        ...
                        <div className="line">
                            <div className="form-group">
                                <div className="text-infos">
                                    <p>Ces données seront utilisés dans les factures au niveau du pied de page.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section>
                        <h2>Pour les devis</h2>
                        <div className="line line-2">
                            <div className="form-group">
                                <div className="line">
                                    <TextArea valeur={noteQuotation} identifiant="noteQuotation" errors={errors} onChange={this.handleChange}>Note</TextArea>
                                </div>

                                <div className="line">
                                    <TextArea valeur={footerQuotation} identifiant="footerQuotation" errors={errors} onChange={this.handleChange}>Pied de page</TextArea>
                                </div>
                    ...
                    <section>
                        <h2>Pour les factures</h2>
                        <div className="line line-2">
                            <div className="form-group">
                                <div className="line">
                                    <TextArea valeur={noteInvoice} identifiant="noteInvoice" errors={errors} onChange={this.handleChange}>Note</TextArea>
                                </div>

                                <div className="line">
                                    <TextArea valeur={footerInvoice} identifiant="footerInvoice" errors={errors} onChange={this.handleChange}>Pied de page</TextArea>
                                </div>
                    ...
                    <section>
                        <h2>Pour les avoirs</h2>
                        <div className="line line-2">
                            <div className="form-group">
                                <div className="line">
                                    <TextArea valeur={noteAvoir} identifiant="noteAvoir" errors={errors} onChange={this.handleChange}>Note</TextArea>
                                </div>

                                <div className="line">
                                    <TextArea valeur={footerAvoir} identifiant="footerAvoir" errors={errors} onChange={this.handleChange}>Pied de page</TextArea>
                                </div>
