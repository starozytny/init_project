...
export function ItemInvoiceFormulaire ({ type, element, societyId, taxes, unities, onSubmit,
                                           selectItems, item, onSelectItem, onCloseAdd, step, noStep = false })
{
    let form = <Form
        type={type ? type : (element ? "update" : "create")}
        onSubmit={onSubmit}
...
class Form extends Component {
    ...
    render () {
        const { type, taxes, unities, selectItems, onSelectItem, onCloseAdd, step, item, noStep } = this.props;
        const { errors, reference, numero, name, content, unity, price, codeTva, rateTva, quantity, totalHt } = this.state;
                ...
                <div className="item-content">
                    ...
                    <div className="item-body">
                        <div className="infos infos-col-7">
                            ...
                            <div className="col-6">
                                ...
                                <div className="line">
                                    <div className="form-group">
                                        ...
                                        <div className="sub">{(totalHt !== "" && rateTva !== "") && <>
                                            {Sanitaze.toFormatCurrency(totalHt * (parseFloat(rateTva)/100) + totalHt)}
                                        </>}</div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-7 actions">
                                {type === "update" ? <>
                                    <ButtonIcon icon="pencil" isSubmit={false} onClick={this.handleSubmit}>Modifier</ButtonIcon>
                                </> : <>
                                    <ButtonIcon icon="add-square" isSubmit={false} onClick={this.handleSubmit}>Ajouter</ButtonIcon>
                                </>}
                            </div>
