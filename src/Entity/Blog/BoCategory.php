...
use App\Repository\Blog\BoCategoryRepository;
...
/**
 * @ORM\Entity(repositoryClass=BoCategoryRepository::class)
 */
class BoCategory
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=BoArticle::class, mappedBy="category")
     */
    private $articles;
